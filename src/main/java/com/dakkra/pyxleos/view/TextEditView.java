...
public class TextEditView {
	...
	public void createAndShowGUI(MainModel m, TextEditModel tem,
		...
		tem.textEditFrame = new JInternalFrame("TextEdit", true, true, true,
				true);
	...
	private class OpenListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			if (returnval == JFileChooser.APPROVE_OPTION) {
				if (!TextEditorFilter.supportedType(tem.openJFC
						.getSelectedFile())) {
	...
	private class SaveAsListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			if (returnval == JFileChooser.APPROVE_OPTION) {
				tem.fileURI = tem.saveJFC.getSelectedFile().getAbsolutePath()
						+ ".txt";
	...
	private class OptionsTextSizeListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			// TODO error handling
			tem.textAreaFont = new Font("Arial", Font.PLAIN,
					Integer.parseInt(JOptionPane.showInputDialog(
							"Input a new font size:",
							tem.textAreaFont.getSize())));
			tem.textArea.setFont(tem.textAreaFont);
		}
	}
}
